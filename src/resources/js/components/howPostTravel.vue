        ...
        <!-- 4 -->
           <div class="row border my-3 py-3">
            <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <h4 class="border-2">Reception du colis</h4>
                  <p>Lors de la rencontre, verifiez la nature des colis et faite une liste de tous les colis à transporter. Demande à l'expediteur de vous faire un procuration, qui atteste que vous transportez les produits listes en son nom.</p>
                </div>
        </div>
        <!--5  -->
           <div class="row border my-3 py-3">
            <div class="col-md-2">
                ...
                <div class="col-md-10">
                    ...
                    <p>Après le trajet et la remise du colis, votre argent sera trafere sur votre compte PayPal. </p>
                </div>
        </div>
        <!--  -->
    </div>
